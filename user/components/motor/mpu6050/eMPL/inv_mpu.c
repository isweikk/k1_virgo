...
#define i2c_write   I2C_SendLongData
#define i2c_read    I2C_ReadLongData
...
uint8_t mpu_dmp_init(void)
{
	...
	if (mpu_init(NULL) == 0) {
		...
		if (res) return 5; 
		res = dmp_enable_feature(DMP_FEATURE_6X_LP_QUAT | DMP_FEATURE_TAP | DMP_FEATURE_ANDROID_ORIENT |  // 设置dmp功能
